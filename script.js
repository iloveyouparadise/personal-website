...
var portfolioData = {
  ...
  "school-04": { index: "04", title: "“谢广军女儿开盒”事件可视化数据新闻", subtitle: "Pr剪辑+Ae数据可视化+动画制作", coverClass: "cover-school-04", videoSrc: "./vedio/可视化数据新闻视频案例.mp4", isPortrait: false, info: [{ label: "时长", value: "07:23" }, { label: "参与部分", value: "剪辑+动效制作" }, { label: "项目介绍", value: "根据“开盒”这一热点新闻事件，透过数据可视化的形式呈现开盒这一行为的表里" }] },
  "school-05": { index: "05", title: "野外实践拍摄案例", subtitle: "野外实践拍摄作品-「寻」", coverClass: "cover-school-05", videoSrc: "./vedio/大学野外实践拍摄剪辑案例.mp4", isPortrait: false, info: [{ label: "时长", value: "02:27" }, { label: "参与部分", value: "拍摄+剪辑（达芬奇）" }, { label: "项目介绍", value: "每个人都渴望知道山后面是什么，可翻过山，会发现那边也没什么，人只是迷恋那种寻找的感觉。" }] },
  "school-06": { index: "06", title: "音乐歌词视频排版", subtitle: "文字排版练习案例", coverClass: "cover-school-06", videoSrc: "./vedio/视频排版练习案例-音乐歌词视频.mp4", isPortrait: false, info: [{ label: "时长", value: "01:47" }, { label: "参与部分", value: "剪辑" }, { label: "项目介绍", value: "根据歌曲「Labyrinth」的歌词和电影「天气之子」的画面，结合进行类似视频文字排版的练习" }] },
  "internship-01": { index: "01", title: "【蔚来】萤光来护驾 一日店长上班记", subtitle: "拍摄使用firefly萤火虫接上猫猫店长，送到领养日活动现场。", coverClass: "cover-internship-01", videoSrc: "./vedio/宠物救助_3剪.mp4", isPortrait: true, info: [{ label: "时长", value: "02:30" }, { label: "参与部分", value: "拍摄+剪辑" }, { label: "项目介绍", value: "快闪竖屏短视频，firefly萤火虫杭州官方将携手杭州领养日，在猫猫躺（自在）生活节举办之时拍摄一条官方小视频，一方面是传递firefly萤火虫宠物友好等功能，一方面意在为后续用户志愿者招募提供前宣素材，进行打样" }] },
  ...
  "internship-07": { index: "07", title: "蔚来旗下品牌「乐道」L80交付活动口播视频", subtitle: "L80交付活动现场拍摄剪辑。", coverClass: "cover-internship-07", videoSrc: "./vedio/L90交付-v6_metool_metool.mp4", isPortrait: false, info: [{ label: "时长", value: "7:45" }, { label: "参与部分", value: "拍摄+剪辑" }, { label: "项目介绍", value: "乐道新车型L80杭州首次交付活动现场口播拍摄+剪辑，当天拍摄，当天出片交付" }] }
};
...
(function() {
  ...
  var caption = container.querySelector('.tilt-caption');
  var amplitude = 16;
  ...
  container.addEventListener('mousemove', function(e) {
    ...
    var rotX = (y / (rect.height / 2)) * -amplitude;
    var rotY = (x / (rect.width / 2)) * amplitude;
    card.style.transform = 'rotateX(' + rotX.toFixed(2) + 'deg) rotateY(' + rotY.toFixed(2) + 'deg) scale3d(1.05, 1.05, 1.05)';

    caption.style.left = (e.clientX + 16) + 'px';
    caption.style.top = (e.clientY - 28) + 'px';
    caption.style.opacity = '1';
    caption.textContent = '唐烨';
  });
