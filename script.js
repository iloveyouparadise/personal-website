...
var portfolioData = {
  ...
  "school-04": { index: "04", title: "“谢广军女儿开盒”事件可视化数据新闻", subtitle: "Pr剪辑+Ae数据可视化+动画制作", coverClass: "cover-school-04", videoSrc: "./vedio/可视化数据新闻视频案例（AE_PR）.mp4", isPortrait: false, info: [{ label: "时长", value: "07:23" }, { label: "参与部分", value: "剪辑+动效制作" }, { label: "项目介绍", value: "根据“开盒”这一热点新闻事件，透过数据可视化的形式呈现开盒这一行为的表里" }] },
