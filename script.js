...
var portfolioData = {
  ...
  "internship-07": { index: "07", title: "蔚来旗下品牌「乐道」L90交付活动宣传视频", subtitle: "L90交付活动现场拍摄剪辑。", coverClass: "cover-internship-07", videoSrc: "./vedio/L90交付-v6_metool_metool.mp4", isPortrait: false, info: [{ label: "时长", value: "请补充" }, { label: "参与部分", value: "拍摄+剪辑" }, { label: "项目介绍", value: "请补充" }] }
};
